...
description: "LMU AI compliance: AI service filing, ICP filing, account data stored within China, no persisted request content, contracts, VAT invoices and DPA."
ogDescription: "LMU AI compliance at a glance for enterprises: AI service filing (Beijing-LMUAI-20251201S0138), verifiable ICP and public-security filings, account data stored only within China, request content never persisted, with procurement contracts, VAT invoices, DPA signing and supporting materials for compliance inquiries."
keywords:
  - Claude API compliance
  - AI API ICP filing
  - AI service filing China
  - LLM API filing number
...
faq:
  ...
  - q: Does LMU AI have an AI service filing?
    a: Yes. The AI service filing number is Beijing-LMUAI-20251201S0138; in addition, the primary domain lmuai.com holds an ICP filing and a public-security filing — all three are listed on the compliance page.
...
| AI service filing | Beijing-LMUAI-20251201S0138 | Below |
...
- **AI service filing**: Beijing-LMUAI-20251201S0138
