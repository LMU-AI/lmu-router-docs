...
description: Step-by-step guide to connecting Chatbox mobile (iOS / Android) to the LMU AI API — open Model Provider from the ☰ menu, configure API Host and API Path for both protocols, direct connection in China with no proxy.
